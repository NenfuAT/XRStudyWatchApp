...
import com.k21091.xrstudywatchapp.common.helpers.SnackbarHelper
import com.k21091.xrstudywatchapp.common.helpers.TapHelper

/** Contains UI elements for Hello AR. */
class HelloArView(val activity: MainActivity) : DefaultLifecycleObserver {

  val root = View.inflate(activity, R.layout.arview, null)
  //↓ここでビュー指定してると思われる
